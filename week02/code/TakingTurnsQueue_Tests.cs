...
public class TakingTurnsQueueTests
{
    ...
    // Defect(s) Found: Found Sue instead of Bob. Cause: Person.Queue.cs Enqueue() was inserting at the wrong position.
    ...
    // Run 10 times.
    // Expected Result: Bob, Tim, Sue, Bob, Tim, Sue, Tim, Sue, Tim, Tim
    // Defect(s) Found: Expected Tim, got Sue. Cause, there was no code implimented in TakingTurnsQueue.cs to handle the case of a person with infinite turns, so it was treating them as if they had only one turn.
    ...
    // Defect(s) Found: No exceptions found
